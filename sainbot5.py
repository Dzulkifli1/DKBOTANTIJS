...
cl = LINE("EyCvaxGPEXYy2Y0PA24e.+r+jAIdxZWQoBO38ex8YVG.kneUAvjglqAvEVWNVjuWK0yZKkc0MEMLUgbZqbc5oZg=")
cl.log("Auth Token : " + str(cl.authToken))

ki = LINE("EyKZhKq5V8U0lR7bSWx5.8OY1iJbE2cs3otqwBUM9rq.4nJLpW2IwpMLRTr73OTVsYh/0GM60FcLKF11M6HbNnk=")
ki.log("Auth Token : " + str(ki.authToken))

kk = LINE("EyUc9L7PbxYpbgRYecJ7.Pjzf3LVZw/XF50kaIyaxnW.iTyACrq4g4UteyH3q6UilPig1KQHN54eefqd5JcZ9kA=")
kk.log("Auth Token : " + str(kk.authToken))

kc = LINE("EyC70ahxoX2Sedemwjkf.iXDW3NqeZe2QwsaB0p/2tW.f7zfzwJTi8JaEMiNVcg906+WLvjm/5cKoeXG3goT+Lw=")
kc.log("Auth Token : " + str(kc.authToken))

sw = LINE("Ey6v1KxLL3aFaakpOz67.ysELs5+0aaJPhSRVRuIgzW.WOte9uoqC8IU2x7o31CCaosb8al1gd+E6Q3J5zQFwiE=")
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu bukan anggota bot dragon")
#ADD STAFF
                 if msg._from in admin:
...
#UPDATE FOTO
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, None, contentMetadata={"STKID":"52114117","STKPKGID":"11539","STKVER":"1"}, contentType=7)
                                cl.sendMessage(msg.to, md)

                        elif cmd == "creator" or text.lower() == 'creator':
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Dragon Bot") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                        ...
                        elif cmd == "absen" or cmd == "pasukan":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t]1 ON")
                                ki.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t]2 ON")
                                kk.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t]3 ON")
                                kc.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t]4 ON")
                                sw.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t]5 ON")
                                cl.sendMessage(msg.to, None, contentMetadata={"STKID":"52002739","STKPKGID":"11537","STKVER":"1"}, contentType=7)
                        ...
                        elif cmd == "momo" or text.lower() == 'mybot':
                            if msg._from in admin:
                                ma = ""
                                for i in Bots:
                                    ma = cl.getContact(i)
...
"RATA NGGA RATA YANG PENTING\n" 
	...
	"╚══╝      ━╚╩╝\n"
           "━━━━━━━━━━"
        "DRAGON KILLER HADIR LGHY BOS Q\n" 
"━━━━━━━━RATA NI" "MAH━━━━━━━━\n"
		"╔═╗╔══╗╔══╗╔══╗\n"
		"║╬║║╔╗║╚╗╔╝║╔╗║\n"
		"║╗╣║╠╣║━║║━║╠╣║\n"
		...
		"━━━━━━━━━━━━━━━\n\nRATA GAK RATA YANG PENTING KIBAR NJIING\n>>>>>>BYE BYE GC LAKNAT<<<<<\nDENDAM CARI KAMI\n\n<<<<<<<<<>>\nhttp://line.me/ti/p/~zulfikar_m1\nhttp://line.me/ti/p/zulfikar_m1")
                          ...
                          if msg._from in admin:
                             cl.sendMessage(msg.to,"❂ ▰▰▰♔ᴏᴘᴇɴᴏʀᴅᴇʀ♔▰▰▰ ❂\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nꜱᴇʟғʙᴏᴛ ᴅᴀɴ ʙᴏᴛ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n➪ ѕ ε lƒвσ т σ и aku ч ρ ч 3\n➪ ѕ ε lƒвσ т + α ит ι j ѕ\n➪ ѕ ε lƒвσ т + 3 α ѕ ι ѕт\n➪ ѕ ε lƒвσ т + 5 α ѕ ι ѕт\n➪ ѕ ε lƒвσ т + 7 α ѕ ι ѕт\n ➪ ѕ ε lƒвσ т + 10 α ѕ ι ѕт\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nɴʙ ﹕ ꜱᴇᴅɪᴀᴋᴀɴ ᴀᴋᴜɴ ʙᴏᴛ ꜱᴇɴᴅɪʀɪ ᴍɪɴᴀᴛ ᴘᴄ ʟᴀɴɢꜱᴜɴɢ\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nDukungan'ि я eeδο м βοτς Λρκ βοτς\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n☞ в σ т ρ я σ т ε c т + α ит ι j ѕ\n☞ в σ т ρ я σ т ε c т σω и ε я + α ит ι j ѕ\n☞ в σ т ρ я σ т ε c т я σσ м ενε ит\n☞ в σ т ρ я σ т ε c т я σσ м ѕм υ lε\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n☞ Kontak : https://line.me/ti/p/~reza.p.i.p\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
                             msg.contentType = 13
...
"NO BAPER \nNO BACOT \nNO DESAH \n\n\nWAR!!! WER!!!WOR!!!\nKENAPE LU PADA DIEM\nTANGKIS NYET TANGKIS\nDASAR ROOM PEA KAGAK BERGUNA\nHAHAHAHHAHAHAHAHAHAHA\nGC LU MAU GUA SITA..!!!\n[DK]DRAGON KILLER\nHADIR DI ROOM ANDA\nRATA GAK RATA YANG PENTING KIBAR NJIING\n>>>>>>BYE BYE GC LAKNAT<<<<<<\nDENDAM CARI KAMI\n\n<<<<<<<<<<>>>>>>>>>>\nhttp://line.me/ti/p/~zulfikar_m1\nhttp://line.me/ti/p/zulfikar_m1")
                               cl.sendMessage(msg.to, None, contentMetadata={"STKID":"52114118","STKPKGID":"11539","STKVER":"1"}, contentType=7)
                               targets = []
                               for g in gs.members:
...
#===========BOT UPDATE============#
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "Kenalin Creator\nBot Kami.. ")
                               cl.sendContact(to, mid)
